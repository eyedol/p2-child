...
<?php do_action( 'before' ); ?>
	...
	<h1><a href="<?php echo home_url( '/' ); ?>"><?php bloginfo( 'name' ); ?></a></h1>
		...
		<?php if ( current_user_can( 'publish_posts' ) ) : ?>
			<span><a href="" id="mobile-post-button" style="display: none;"><?php _e( 'Post', 'p2' ) ?></a></span>
		<?php endif; ?>	
	<!-- Google Public Location Badge -->
<iframe src="http://www.google.com/latitude/apps/badge/api?user=3566689613755363308&type=iframe&maptype=roadmap&z=10" width="980" height="263" frameborder="0"></iframe>
